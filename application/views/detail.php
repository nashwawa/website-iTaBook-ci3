  ...
  <div class="slider-item caraousel-inner" style="display: flex; align-items: center; gap: 40px;">
    ...
    <div class="col-md-4">
      <figure class="banner-image mt-0.5">
        <img src="<?= base_url('assets/upload/konten/' . $konten->foto) ?>" alt="book" style="max-width: 370px; height: auto; border-radius: 12px; margin-right: 30px; transform: scale(1.4);" class="single-image">
      </figure>
    </div>
	...
	<div class="product-entry mt-6" >
		...
		<br>
		<a href="<?php echo base_url('home/tambah_keranjang/' . $konten->id_konten) ?>" 
			style="display: inline-block; background: linear-gradient(45deg,rgb(120, 93, 12), rgb(120, 93, 12)); color: #fff; text-decoration: none; font-weight: bold; padding: 12px 20px; border-radius: 25px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); transition: all 0.3s ease-in-out;" 
			onmouseover="this.style.background='linear-gradient(45deg, rgb(120, 93, 12),rgb(120, 93, 12)'; this.style.transform='scale(1.05)'; this.style.boxShadow='0 6px 12px rgba(0, 0, 0, 0.3)';" 
			onmouseout="this.style.background='linear-gradient(45deg, rgb(120, 93, 12), rgb(120, 93, 12))'; this.style.transform='scale(1)'; this.style.boxShadow='0 4px 8px rgba(0, 0, 0, 0.2)';" 
			...
			<i class="fas fa-shopping-cart" style="margin-right: 8px;"></i> Masukkan Keranjang
		</a>
